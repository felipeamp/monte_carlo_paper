...
7. Attribute Information:
   ...
   2. Wife's education               (categorical)      1=low, 2=avg-low, 3=avg-high, 4=high
   3. Husband's education            (categorical)      1=low, 2=avg-low, 3=avg-high, 4=high
   4. Number of children ever born   (numerical)
   5. Wife's religion                (binary)           0=Non-Islam, 1=Islam
   6. Wife's now working?            (binary)           0=Yes, 1=No
   7. Husband's occupation           (categorical)      1, 2, 3, 4
   8. Standard-of-living index       (categorical)      1=low, 2=avg-low, 3=avg-high, 4=high
